...
| T-25 | 系统标签中文字面量泄漏进 Python，成为第三份排除规则实现 | Architect | `module-coupling` | P1 | S | `agent/stages/curate.py:36`、`cli/commands/commands.cpp:686-688`、`core/tagging/tagging.h:123,137` | ~1h (AI) | T-16 |
