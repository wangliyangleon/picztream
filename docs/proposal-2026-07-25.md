...
| T-9a | Ctrl-C 这条被文档明确推荐的逃生口会毁掉终端：全仓零信号处理，默认 SIGINT 不做栈回退，`AltScreen` 析构永不执行 | User | `ux-friction` | P1 | XS | `cli/term/cbreak_mode.h:6-17`、`cli/term/screen.h:44-54`、`cli/main.cpp:31-35` | ~40min (AI) | none |
