...
| T-17 两图对比选片（`/pick <N>` 人工锦标赛） | [#34](https://github.com/wangliyangleon/picztream/issues/34) | 2026-08-21 | 第五份，原生开在 Issues 上。立项时 D-1..D-20 全部拍板，无待确认项。五张实现票 [#35](https://github.com/wangliyangleon/picztream/issues/35)-[#39](https://github.com/wangliyangleon/picztream/issues/39)，依赖序 `A → B → C → E`、`D` 与 A/B/C 并行；尚未开工 |
