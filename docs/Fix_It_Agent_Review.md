...
2. **第二波(一到两天)**:AG-01 + AG-02 + AG-16.1 作为一个"Style 闸门健壮化"小增量一起做(同一片代码,分开做会互相返工);顺手 AG-04(闸门重复提问)。**Style 闸门健壮化(AG-01+AG-02+AG-16.1,顺带 AG-16.4 基础版)已完成(2026-07-18);AG-04 待做。**
