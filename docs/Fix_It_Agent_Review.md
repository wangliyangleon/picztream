...
3. **第三波**:P2 里按真机痛感排(建议 AG-09 caption、AG-10 retryable、AG-08 先行,AG-11/AG-12/AG-14 属于"跑得越久越重要"的后台健壮性,部署周(W2026-07-15 目标四)开始前做完最合适)。**✅ 已全部完成(2026-07-18): AG-08 `c80fb65`、AG-09 `8c9afae`、AG-10 `072682f`、AG-11 `08ca3a2`、AG-12 `223df5f`、AG-14 见本轮 commit。剩余 P2 未在本三波点名的 AG-07/AG-13/AG-15 仍待排期。**
4. P3 不排期,随手或等触发。
