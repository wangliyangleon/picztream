...
> **归档说明（2026-08-03）**：服务对象 `docs/history/Intent_Curation_PRD.md` 已收口归档，本笔记随之归档。笔记本身没有过期 - 它只陈述已发表证据、不含方案，日后再动预筛算法或再评估本地模型能力时仍可直接引用。

- **日期**：2026-08-01
- **服务对象**：`docs/history/Intent_Curation_PRD.md` 决策十至十二（多样性预筛，ticket 04）与风险二、风险三
