...
def build_runtime(state_dir: Path, transport: Any, chat_id: str,
    ...
    worker = SessionWorker(
        ...
        classify_fns={
            "collecting": _bind(classify_collecting_message),
            "gate_reply": _bind(classify_gate_reply),
            "refine_plan": _bind(refine_plan_confirmation),
            "style_describe": _bind(classify_style_describe),
            "style_gate": _bind(classify_style_gate_reply),
            "dedup_followup": _bind(classify_dedup_followup),
            "running": _bind(classify_running_message),
            "cancel_confirm": _bind(classify_cancel_confirmation),
        },
    )
